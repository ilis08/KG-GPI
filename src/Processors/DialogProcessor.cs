...
namespace Draw
{
	...
	public class DialogProcessor : DisplayProcessor
	{
		...
		public static void SaveAsFileDraw(string path, List<Shape> data)
		{
			var json = JsonConvert.SerializeObject(data);
			File.WriteAllText(path, json);
		}

		public static void OpenAsFileDraw(string path, DoubleBufferedPanel panel)
		{
			...
			foreach (var item in uploadList)
			{
				switch (item.Id)
				{
					...
					case 3:
						...
						break;
					case 4:
						panel.AddRandomHouse(panel);
						break;
					case 5:
						panel.AddRandomNewPrimitive(panel);
						break;
				}
			}
		}
		...
		public string OpenDialog(string text, string caption)
        {
			...
			TextBox box = new TextBox() { Left = 50, Top = 70, Width = 400 };
			Button confirm = new Button() { Text = "Ok", Left = 350, Width = 100, Top = 120, DialogResult = DialogResult.OK };
